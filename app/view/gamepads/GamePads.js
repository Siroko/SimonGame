...
GamePads.prototype.loadAssets = function(){
    ...
    objLoader.load( 'hand-zombie-right.obj', ( function ( object ) {
        this.h1Handler =  new THREE.Object3D();
        var m = new THREE.MeshLambertMaterial({
            map : THREE.ImageUtils.loadTexture('assets/models/hand-zombie-diffuse.png'),
            lightMap: THREE.ImageUtils.loadTexture('assets/models/hand-zombie-right-occlusion.png')
        });
        object.children[0].material = m;

        object.add( this.h1Handler );
        this.h1.add(object);
    } ).bind( this ), onProgress, onError );

    objLoader.load( 'hand-zombie-left.obj', ( function ( object ) {
        this.h2Handler =  new THREE.Object3D();
        object.add( this.h2Handler );
        var m = new THREE.MeshLambertMaterial({
            map : THREE.ImageUtils.loadTexture('assets/models/hand-zombie-diffuse.png'),
            lightMap: THREE.ImageUtils.loadTexture('assets/models/hand-zombie-left-occlusion.png')
        });
        object.children[0].material = m;
